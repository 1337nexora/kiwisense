...
Fatality.Windows = {};
Fatality.FontSemiBold = Font.new('rbxasset://fonts/families/Poppins.json',Enum.FontWeight.SemiBold,Enum.FontStyle.Normal);
Fatality.Flags = {};
Fatality.Colors = {
    Black = Color3.fromRGB(10, 11, 15),
    ...
    Accent = Color3.fromRGB(34, 211, 238),       -- циан, свой акцент
    AccentSoft = Color3.fromRGB(103, 232, 249),  -- светлый циан
    AccentWarm = Color3.fromRGB(45, 212, 191),   -- бирюзовый
    Glow = Color3.fromRGB(56, 189, 248),         -- голубое свечение
    Success = Color3.fromRGB(52, 211, 153),
    Warning = Color3.fromRGB(251, 191, 36),
    Danger = Color3.fromRGB(248, 113, 113),
    TextMain = Color3.fromRGB(245, 247, 252),
    TextDim = Color3.fromRGB(156, 163, 175),
    Overlay = Color3.fromRGB(6, 7, 10)          -- тёмный слой для оверлеев
}
...
function Fatality:CreateElements(Parent : Frame , ZIndex : number , Event : BindableEvent,SearchAPI: {Path: string,Memory : (name:string) -> any}) : Elements
	...
	function elements:AddToggle(Config: Toggle)
		...
		ValueFrame.BackgroundColor3 = Color3.fromRGB(42, 45, 56)
		...
		ValueIcon.BackgroundColor3 = Color3.fromRGB(190, 195, 208)
		...
		ValueKnobCorner.Parent = ValueIcon
		...
		local toggleImg = function(value)
			if value then
				Fatality:CreateAnimation(ValueFrame,0.25,{
					BackgroundColor3 = Fatality.Colors.Accent,
					BackgroundTransparency = 0,
				})
				...
				Fatality:CreateAnimation(ValueIcon,0.25,{
					...
					BackgroundColor3 = Color3.fromRGB(190, 195, 208),
					BackgroundTransparency = 0,
				})
			end;
		end;
		...
		Fatality:CreateHover(ValueFrame,function(b)
			if not Config.Default then
				if b then
					Fatality:CreateAnimation(ValueFrame,0.25,{
						BackgroundColor3 = Color3.fromRGB(58, 62, 76),
					})
				else
					Fatality:CreateAnimation(ValueFrame,0.25,{
						BackgroundColor3 = Color3.fromRGB(42, 45, 56),
	...
	function elements:AddKeybind(Config: Keybind)
		...
		ValueFrame.AnchorPoint = Vector2.new(1, 0.5)
		ValueFrame.BackgroundColor3 = Color3.fromRGB(30, 33, 42)
		ValueFrame.BorderColor3 = Color3.fromRGB(0, 0, 0)
		ValueFrame.BorderSizePixel = 0
		ValueFrame.Position = UDim2.new(1, -3, 0.5, 0)
...
function Fatality.new(Window: Window)
	...
	FatalFrame.BackgroundColor3 = Fatality.Colors.Background
	...
	Header.Active = true
	Header.BackgroundColor3 = Fatality.Colors.Surface
	...
	HeaderLine.BackgroundColor3 = Color3.fromRGB(40, 44, 56)
	...
	HeaderText.TextColor3 = Color3.fromRGB(245, 247, 252)
	HeaderText.TextSize = 21.000
	HeaderText.TextStrokeColor3 = Fatality.Colors.Accent
	HeaderText.TextStrokeTransparency = 0.850
	...
	User_name.ZIndex = 4
	User_name.FontFace = Fatality.FontSemiBold
	...
	expire_days.FontFace = Fatality.FontSemiBold
	expire_days.Text = string.format("<font transparency=\"0.5\">expires:</font> <font color=\"#22d3ee\">%s</font>",Window.Expire)
	...
	Bottom.BackgroundColor3 = Fatality.Colors.Surface
	...
	HeaderLine_2.BackgroundColor3 = Color3.fromRGB(40, 44, 56)
	...
	function Fatal:SetExpire(str: string)
		expire_days.Text = string.format("<font transparency=\"0.5\">expires:</font> <font color=\"#22d3ee\">%s</font>",str)
	end;
	...
	function Fatal:AddMenu(Menu : Menu)
		...
		function MenuLib:AddSection(Config : Section)
			...
			Section.BackgroundColor3 = Fatality.Colors.Background
			...
			Elements.AnchorPoint = Vector2.new(0.5, 1)
			Elements.BackgroundColor3 = Fatality.Colors.Surface
			Elements.BackgroundTransparency = 0
			Elements.BorderColor3 = Color3.fromRGB(0, 0, 0)
			Elements.BorderSizePixel = 0
			Elements.Position = UDim2.new(0.5, 0, 1, -1)
			...
			UIStroke.Color = Color3.fromRGB(40, 44, 56)
			UIStroke.Parent = Elements
...
function Fatality:ExportConfig(WindowObj, FileName)
	local HttpService = game:GetService("HttpService")
	if WindowObj and WindowObj.GetFlagConfig then
		local flags = WindowObj:GetFlagConfig()
		if writefile then
...
function Fatality:ImportConfig(WindowObj, FileName)
	local HttpService = game:GetService("HttpService")
	if isfile and isfile(FileName) and WindowObj and WindowObj.LoadConfig then
		local success, result = pcall(function()
			return HttpService:JSONDecode(readfile(FileName))
		end)
		if success and type(result) == "table" then
			WindowObj:LoadConfig(result)
			return true
		end
	end
	return false
